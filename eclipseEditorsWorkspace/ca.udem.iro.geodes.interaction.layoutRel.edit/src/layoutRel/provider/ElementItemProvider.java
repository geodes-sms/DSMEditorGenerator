...
/**
 * This is the item provider adapter for a {@link layoutRel.Element} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LayoutRelPackage.Literals.ELEMENT__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LayoutRelPackage.Literals.ELEMENT__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addXPosPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_xPos_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_xPos_feature", "_UI_Element_type"),
				 LayoutRelPackage.Literals.ELEMENT__XPOS,
				 true,
				 false,
				 false,
	...
	protected void addYPosPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_yPos_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_yPos_feature", "_UI_Element_type"),
				 LayoutRelPackage.Literals.ELEMENT__YPOS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addIsDefaultPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_isDefault_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_isDefault_feature", "_UI_Element_type"),
				 LayoutRelPackage.Literals.ELEMENT__IS_DEFAULT,
				 true,
				 false,
				 false,
