...
/**
 * This is the item provider adapter for a {@link layout.Constraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LayoutPackage.Literals.CONSTRAINT__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LayoutPackage.Literals.CONSTRAINT__TARGET,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LayoutPackage.Literals.CONSTRAINT__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addAxisPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constraint_axis_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constraint_axis_feature", "_UI_Constraint_type"),
				 LayoutPackage.Literals.CONSTRAINT__AXIS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LayoutPackage.Literals.CONSTRAINT__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		ConstraintType labelValue = ((Constraint)object).getType();
