...
/**
 * This is the item provider adapter for a {@link mapping.CodeLine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CodeLineItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CodeLine_line_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CodeLine_line_feature", "_UI_CodeLine_type"),
				 MappingPackage.Literals.CODE_LINE__LINE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((CodeLine)object).getLine();
		return label == null || label.length() == 0 ?
			getString("_UI_CodeLine_type") :
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CodeLine.class)) {
			case MappingPackage.CODE_LINE__LINE:
