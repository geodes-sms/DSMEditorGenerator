 ...
 * </p>
 * <ul>
 *   <li>{@link layoutRel.impl.ContainerElementImpl#getElements <em>Elements</em>}</li>
 *   <li>{@link layoutRel.impl.ContainerElementImpl#getVisibility <em>Visibility</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContainerElementImpl extends ElementImpl implements ContainerElement {
	/**
	...
	protected EClass eStaticClass() {
		return LayoutRelPackage.Literals.CONTAINER_ELEMENT;
	}
	...
	public EList<Element> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<Element>(Element.class, this, LayoutRelPackage.CONTAINER_ELEMENT__ELEMENTS);
		}
		return elements;
	}
	...
	public void setVisibility(int newVisibility) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LayoutRelPackage.CONTAINER_ELEMENT__VISIBILITY, oldVisibility, visibility));
	}
