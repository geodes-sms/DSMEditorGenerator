...
public class InteractionSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case InteractionPackage.CELEMENT: {
				CElement cElement = (CElement)theEObject;
				T result = caseCElement(cElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InteractionPackage.IELEMENT: {
				IElement iElement = (IElement)theEObject;
				T result = caseIElement(iElement);
				if (result == null) result = caseCElement(iElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InteractionPackage.OELEMENT: {
				OElement oElement = (OElement)theEObject;
				T result = caseOElement(oElement);
				if (result == null) result = caseCElement(oElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InteractionPackage.LELEMENT: {
				LElement lElement = (LElement)theEObject;
				T result = caseLElement(lElement);
				if (result == null) result = caseCElement(lElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InteractionPackage.VELEMENT: {
				VElement vElement = (VElement)theEObject;
				T result = caseVElement(vElement);
				if (result == null) result = caseCElement(vElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InteractionPackage.INTERACTIONS: {
				Interactions interactions = (Interactions)theEObject;
				T result = caseInteractions(interactions);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InteractionPackage.ATOMIC_INTERACTION: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>OElement</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>OElement</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOElement(OElement object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>LElement</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>LElement</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLElement(LElement object) {
		return null;
	}
