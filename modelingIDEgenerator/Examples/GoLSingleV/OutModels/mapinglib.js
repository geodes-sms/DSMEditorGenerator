...
var remCell = function(element){
	this.event.target.remove();
}

var addCell = function(canvasID){
    ...
    rect.setAttribute('data-type',"Cell");
    rect.setAttribute('id',"Cell");
    ...
    rect.setAttribute('data-name',"Cell");
...
var simulateGoL = function(){
  ...
  setTimeout(function afterTwoSeconds() {
    GoLSingleV.Interaction.prototype.triggerEvent(event,event.target.id,'_finish');
  }, 1000);
}
