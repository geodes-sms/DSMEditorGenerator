...
Date:   Sat Apr 27 23:35:32 2019

Model author: Vasco and Khady
Model name:   Synthetic10H
Model description:
RunGhostGameofLifeEditor*/


// package "Synthetic10H"
var Synthetic10H = {};
(function() {
...
Interaction.prototype.user_defined_constructor = function() {
    ...
    document.getElementById("E1").addEventListener("click", function() {Synthetic10H.Interaction.prototype.triggerEvent(event,"E1",'event');}, false);
    document.getElementById("E2").addEventListener("click", function() {Synthetic10H.Interaction.prototype.triggerEvent(event,"E2",'event');}, false);
    document.getElementById("E3").addEventListener("click", function() {Synthetic10H.Interaction.prototype.triggerEvent(event,"E3",'event');}, false);
    document.getElementById("E4").addEventListener("click", function() {Synthetic10H.Interaction.prototype.triggerEvent(event,"E4",'event');}, false);
    document.getElementById("E5").addEventListener("click", function() {Synthetic10H.Interaction.prototype.triggerEvent(event,"E5",'event');}, false);
    document.getElementById("E6").addEventListener("click", function() {Synthetic10H.Interaction.prototype.triggerEvent(event,"E6",'event');}, false);
    document.getElementById("E7").addEventListener("click", function() {Synthetic10H.Interaction.prototype.triggerEvent(event,"E7",'event');}, false);
    document.getElementById("E8").addEventListener("click", function() {Synthetic10H.Interaction.prototype.triggerEvent(event,"E8",'event');}, false);
    document.getElementById("E9").addEventListener("click", function() {Synthetic10H.Interaction.prototype.triggerEvent(event,"E9",'event');}, false);
    document.getElementById("E10").addEventListener("click", function() {Synthetic10H.Interaction.prototype.triggerEvent(event,"E10",'event');}, false);
    document.getElementById("23").addEventListener("click",function() {Synthetic10H.Interaction.prototype.triggerEvent(event,event.target.id,'select');}, false);
};
...
Interaction.prototype.build_statechart_structure = function() {
    ...
    this.states["/System/LayerE3/s13"] = new State(10, this);
    ...
    this.states["/System/LayerE10"] = new State(24, this);
    
    // state /System/LayerE10/s10
    this.states["/System/LayerE10/s10"] = new State(25, this);
    
    // state /System/LayerE10/s14
    this.states["/System/LayerE10/s14"] = new State(26, this);
    
    // state /System/LayerControler
    this.states["/System/LayerControler"] = new State(27, this);
    
    // state /System/LayerControler/h00
    this.states["/System/LayerControler/h00"] = new State(28, this);
    
    // state /System/LayerController
    this.states["/System/LayerController"] = new State(29, this);
    
    // state /System/LayerController/controller
    this.states["/System/LayerController/controller"] = new State(30, this);
    ...
    var _System_LayerE10_s14_0 = new Transition(this, this.states["/System/LayerE10/s14"], [this.states["/System/LayerE10/s10"]]);
...
Interaction.prototype._System_LayerControler_h00_0_guard = function(parameters) {
    return this.inState(["/System/LayerE4/s4"]) and this.inState(["/System/Layercanvas/s2"]) and this.type == 'E4';
};
...
// add symbol 'Interaction' to package 'Synthetic10H'
Synthetic10H.Interaction = Interaction;
...
// add symbol 'ObjectManager' to package 'Synthetic10H'
Synthetic10H.ObjectManager = ObjectManager;
...
// add symbol 'Controller' to package 'Synthetic10H'
Synthetic10H.Controller = Controller;
})();