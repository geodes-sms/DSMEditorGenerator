...
Date:   Sat Apr 27 22:22:54 2019

Model author: Vasco and Khady
Model name:   Synthetic5G
Model description:
...
Interaction.prototype.user_defined_constructor = function() {
    ...
    document.getElementById("E1").addEventListener("click", function() {Synthetic5G.Interaction.prototype.triggerEvent(event,"E1",'event');}, false);
    document.getElementById("E2").addEventListener("click", function() {Synthetic5G.Interaction.prototype.triggerEvent(event,"E2",'event');}, false);
    document.getElementById("E3").addEventListener("click", function() {Synthetic5G.Interaction.prototype.triggerEvent(event,"E3",'event');}, false);
    document.getElementById("E4").addEventListener("click", function() {Synthetic5G.Interaction.prototype.triggerEvent(event,"E4",'event');}, false);
    document.getElementById("E5").addEventListener("click", function() {Synthetic5G.Interaction.prototype.triggerEvent(event,"E5",'event');}, false);
    document.getElementById("E6").addEventListener("click", function() {Synthetic5G.Interaction.prototype.triggerEvent(event,"E6",'event');}, false);
    document.getElementById("E7").addEventListener("click", function() {Synthetic5G.Interaction.prototype.triggerEvent(event,"E7",'event');}, false);
    document.getElementById("E8").addEventListener("click", function() {Synthetic5G.Interaction.prototype.triggerEvent(event,"E8",'event');}, false);
    document.getElementById("E9").addEventListener("click", function() {Synthetic5G.Interaction.prototype.triggerEvent(event,"E9",'event');}, false);
    document.getElementById("E10").addEventListener("click", function() {Synthetic5G.Interaction.prototype.triggerEvent(event,"E10",'event');}, false);
    document.getElementById("23").addEventListener("click",function() {Synthetic5G.Interaction.prototype.triggerEvent(event,event.target.id,'select');}, false);
};
...
Interaction.prototype.build_statechart_structure = function() {
    ...
    this.states["/System/LayerE3/s14"] = new State(10, this);
    ...
    this.states["/System/LayerE6/s12"] = new State(18, this);
    ...
    this.states["/System/LayerE10/s13"] = new State(27, this);
    
    // state /System/LayerE10/s15
    this.states["/System/LayerE10/s15"] = new State(28, this);
...
// add symbol 'Interaction' to package 'Synthetic5G'
Synthetic5G.Interaction = Interaction;
...
// add symbol 'ObjectManager' to package 'Synthetic5G'
Synthetic5G.ObjectManager = ObjectManager;
...
// add symbol 'Controller' to package 'Synthetic5G'
Synthetic5G.Controller = Controller;
})();