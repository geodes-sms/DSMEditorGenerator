...
Date:   Sun Apr 28 02:22:32 2019

Model author: Vasco and Khady
Model name:   Synthetic10J
Model description:
RunGhostGameofLifeEditor*/


// package "Synthetic10J"
var Synthetic10J = {};
(function() {
...
Interaction.prototype.user_defined_constructor = function() {
    ...
    document.getElementById("E1").addEventListener("click", function() {Synthetic10J.Interaction.prototype.triggerEvent(event,"E1",'event');}, false);
    document.getElementById("E2").addEventListener("click", function() {Synthetic10J.Interaction.prototype.triggerEvent(event,"E2",'event');}, false);
    document.getElementById("E3").addEventListener("click", function() {Synthetic10J.Interaction.prototype.triggerEvent(event,"E3",'event');}, false);
    document.getElementById("E4").addEventListener("click", function() {Synthetic10J.Interaction.prototype.triggerEvent(event,"E4",'event');}, false);
    document.getElementById("E5").addEventListener("click", function() {Synthetic10J.Interaction.prototype.triggerEvent(event,"E5",'event');}, false);
    document.getElementById("E6").addEventListener("click", function() {Synthetic10J.Interaction.prototype.triggerEvent(event,"E6",'event');}, false);
    document.getElementById("E7").addEventListener("click", function() {Synthetic10J.Interaction.prototype.triggerEvent(event,"E7",'event');}, false);
    document.getElementById("E8").addEventListener("click", function() {Synthetic10J.Interaction.prototype.triggerEvent(event,"E8",'event');}, false);
    document.getElementById("E9").addEventListener("click", function() {Synthetic10J.Interaction.prototype.triggerEvent(event,"E9",'event');}, false);
    document.getElementById("E10").addEventListener("click", function() {Synthetic10J.Interaction.prototype.triggerEvent(event,"E10",'event');}, false);
    document.getElementById("23").addEventListener("click",function() {Synthetic10J.Interaction.prototype.triggerEvent(event,event.target.id,'select');}, false);
};
...
Interaction.prototype.build_statechart_structure = function() {
    ...
    this.states["/System/LayerE9"] = new State(22, this);
    
    // state /System/LayerE9/s9
    this.states["/System/LayerE9/s9"] = new State(23, this);
    
    // state /System/LayerE9/s14
    this.states["/System/LayerE9/s14"] = new State(24, this);
    ...
    this.states["/System/LayerControler"] = new State(28, this);
    
    // state /System/LayerControler/h00
    this.states["/System/LayerControler/h00"] = new State(29, this);
    
    // state /System/LayerController
    this.states["/System/LayerController"] = new State(30, this);
    
    // state /System/LayerController/controller
    this.states["/System/LayerController/controller"] = new State(31, this);
    ...
    _System_LayerE2_s0_2.setTrigger(new Event("event0", null));
    this.states["/System/LayerE2/s0"].addTransition(_System_LayerE2_s0_2);
    
    // transition /System/LayerE2/s12
    var _System_LayerE2_s12_0 = new Transition(this, this.states["/System/LayerE2/s12"], [this.states["/System/LayerE2/s0"]]);
...
Interaction.prototype._System_LayerControler_h00_1_guard = function(parameters) {
    return this.inState(["/System/LayerE8/s8"]) and this.inState(["/System/LayerE1/s1"]) and this.inState(["/System/LayerE2/s0"]) and this.type == 'E8';
};
...
Interaction.prototype._System_LayerControler_h00_2_guard = function(parameters) {
    return this.inState(["/System/Layercanvas/s2"]) and this.inState(["/System/LayerE10/s10"]) and this.inState(["/System/LayerE2/s0"]) and this.inState(["/System/LayerE7/s7"]) and this.inState(["/System/LayerE4/s4"]) and this.type == 'E1';
};
...
// add symbol 'Interaction' to package 'Synthetic10J'
Synthetic10J.Interaction = Interaction;
...
// add symbol 'ObjectManager' to package 'Synthetic10J'
Synthetic10J.ObjectManager = ObjectManager;
...
// add symbol 'Controller' to package 'Synthetic10J'
Synthetic10J.Controller = Controller;
})();