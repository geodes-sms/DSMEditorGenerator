...
Date:   Sat Apr 27 22:57:22 2019

Model author: Vasco and Khady
Model name:   Synthetic100G
Model description:
RunGhostGameofLifeEditor*/


// package "Synthetic100G"
var Synthetic100G = {};
(function() {
...
Interaction.prototype.user_defined_constructor = function() {
    ...
    document.getElementById("E1").addEventListener("click", function() {Synthetic100G.Interaction.prototype.triggerEvent(event,"E1",'event');}, false);
    document.getElementById("E2").addEventListener("click", function() {Synthetic100G.Interaction.prototype.triggerEvent(event,"E2",'event');}, false);
    document.getElementById("E3").addEventListener("click", function() {Synthetic100G.Interaction.prototype.triggerEvent(event,"E3",'event');}, false);
    document.getElementById("E4").addEventListener("click", function() {Synthetic100G.Interaction.prototype.triggerEvent(event,"E4",'event');}, false);
    document.getElementById("E5").addEventListener("click", function() {Synthetic100G.Interaction.prototype.triggerEvent(event,"E5",'event');}, false);
    document.getElementById("E6").addEventListener("click", function() {Synthetic100G.Interaction.prototype.triggerEvent(event,"E6",'event');}, false);
    document.getElementById("E7").addEventListener("click", function() {Synthetic100G.Interaction.prototype.triggerEvent(event,"E7",'event');}, false);
    document.getElementById("E8").addEventListener("click", function() {Synthetic100G.Interaction.prototype.triggerEvent(event,"E8",'event');}, false);
    document.getElementById("E9").addEventListener("click", function() {Synthetic100G.Interaction.prototype.triggerEvent(event,"E9",'event');}, false);
    document.getElementById("E10").addEventListener("click", function() {Synthetic100G.Interaction.prototype.triggerEvent(event,"E10",'event');}, false);
    document.getElementById("23").addEventListener("click",function() {Synthetic100G.Interaction.prototype.triggerEvent(event,event.target.id,'select');}, false);
};
...
Interaction.prototype.build_statechart_structure = function() {
    ...
    this.states["/System/LayerE3/s13"] = new State(11, this);
    ...
    this.states["/System/LayerE4/s12"] = new State(15, this);
    ...
    this.states["/System/LayerE7/s17"] = new State(22, this);
    ...
    this.states["/System/LayerE10/s16"] = new State(29, this);
    ...
    var _System_LayerE3_s13_1 = new Transition(this, this.states["/System/LayerE3/s13"], [this.states["/System/LayerE3/s14"]]);
    ...
    var _System_LayerE3_s14_0 = new Transition(this, this.states["/System/LayerE3/s14"], [this.states["/System/LayerE3/s13"]]);
    ...
    var _System_LayerE3_s14_1 = new Transition(this, this.states["/System/LayerE3/s14"], [this.states["/System/LayerE3/s14"]]);
...
// add symbol 'Interaction' to package 'Synthetic100G'
Synthetic100G.Interaction = Interaction;
...
// add symbol 'ObjectManager' to package 'Synthetic100G'
Synthetic100G.ObjectManager = ObjectManager;
...
// add symbol 'Controller' to package 'Synthetic100G'
Synthetic100G.Controller = Controller;
})();