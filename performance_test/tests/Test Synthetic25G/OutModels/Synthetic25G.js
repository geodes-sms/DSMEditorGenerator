...
Date:   Sat Apr 27 22:39:30 2019

Model author: Vasco and Khady
Model name:   Synthetic25G
Model description:
RunGhostGameofLifeEditor*/


// package "Synthetic25G"
var Synthetic25G = {};
(function() {
...
Interaction.prototype.user_defined_constructor = function() {
    ...
    document.getElementById("E1").addEventListener("click", function() {Synthetic25G.Interaction.prototype.triggerEvent(event,"E1",'event');}, false);
    document.getElementById("E2").addEventListener("click", function() {Synthetic25G.Interaction.prototype.triggerEvent(event,"E2",'event');}, false);
    document.getElementById("E3").addEventListener("click", function() {Synthetic25G.Interaction.prototype.triggerEvent(event,"E3",'event');}, false);
    document.getElementById("E4").addEventListener("click", function() {Synthetic25G.Interaction.prototype.triggerEvent(event,"E4",'event');}, false);
    document.getElementById("E5").addEventListener("click", function() {Synthetic25G.Interaction.prototype.triggerEvent(event,"E5",'event');}, false);
    document.getElementById("E6").addEventListener("click", function() {Synthetic25G.Interaction.prototype.triggerEvent(event,"E6",'event');}, false);
    document.getElementById("E7").addEventListener("click", function() {Synthetic25G.Interaction.prototype.triggerEvent(event,"E7",'event');}, false);
    document.getElementById("E8").addEventListener("click", function() {Synthetic25G.Interaction.prototype.triggerEvent(event,"E8",'event');}, false);
    document.getElementById("E9").addEventListener("click", function() {Synthetic25G.Interaction.prototype.triggerEvent(event,"E9",'event');}, false);
    document.getElementById("E10").addEventListener("click", function() {Synthetic25G.Interaction.prototype.triggerEvent(event,"E10",'event');}, false);
    document.getElementById("23").addEventListener("click",function() {Synthetic25G.Interaction.prototype.triggerEvent(event,event.target.id,'select');}, false);
};
...
// add symbol 'Interaction' to package 'Synthetic25G'
Synthetic25G.Interaction = Interaction;
...
// add symbol 'ObjectManager' to package 'Synthetic25G'
Synthetic25G.ObjectManager = ObjectManager;
...
// add symbol 'Controller' to package 'Synthetic25G'
Synthetic25G.Controller = Controller;
})();