...
Date:   Sun Apr 28 00:48:42 2019

Model author: Vasco and Khady
Model name:   Synthetic50I
Model description:
RunGhostGameofLifeEditor*/


// package "Synthetic50I"
var Synthetic50I = {};
(function() {
...
Interaction.prototype.user_defined_constructor = function() {
    ...
    document.getElementById("E1").addEventListener("click", function() {Synthetic50I.Interaction.prototype.triggerEvent(event,"E1",'event');}, false);
    document.getElementById("E2").addEventListener("click", function() {Synthetic50I.Interaction.prototype.triggerEvent(event,"E2",'event');}, false);
    document.getElementById("E3").addEventListener("click", function() {Synthetic50I.Interaction.prototype.triggerEvent(event,"E3",'event');}, false);
    document.getElementById("E4").addEventListener("click", function() {Synthetic50I.Interaction.prototype.triggerEvent(event,"E4",'event');}, false);
    document.getElementById("E5").addEventListener("click", function() {Synthetic50I.Interaction.prototype.triggerEvent(event,"E5",'event');}, false);
    document.getElementById("E6").addEventListener("click", function() {Synthetic50I.Interaction.prototype.triggerEvent(event,"E6",'event');}, false);
    document.getElementById("E7").addEventListener("click", function() {Synthetic50I.Interaction.prototype.triggerEvent(event,"E7",'event');}, false);
    document.getElementById("E8").addEventListener("click", function() {Synthetic50I.Interaction.prototype.triggerEvent(event,"E8",'event');}, false);
    document.getElementById("E9").addEventListener("click", function() {Synthetic50I.Interaction.prototype.triggerEvent(event,"E9",'event');}, false);
    document.getElementById("E10").addEventListener("click", function() {Synthetic50I.Interaction.prototype.triggerEvent(event,"E10",'event');}, false);
    document.getElementById("23").addEventListener("click",function() {Synthetic50I.Interaction.prototype.triggerEvent(event,event.target.id,'select');}, false);
};
...
Interaction.prototype.build_statechart_structure = function() {
    ...
    this.states["/System/LayerE1/s13"] = new State(6, this);
    ...
    this.states["/System/LayerE6"] = new State(15, this);
    
    // state /System/LayerE6/s6
    this.states["/System/LayerE6/s6"] = new State(16, this);
    
    // state /System/LayerE7
    this.states["/System/LayerE7"] = new State(17, this);
    
    // state /System/LayerE7/s7
    this.states["/System/LayerE7/s7"] = new State(18, this);
    
    // state /System/LayerE7/s15
    this.states["/System/LayerE7/s15"] = new State(19, this);
    
    // state /System/LayerE8
    this.states["/System/LayerE8"] = new State(20, this);
    
    // state /System/LayerE8/s8
    this.states["/System/LayerE8/s8"] = new State(21, this);
    
    // state /System/LayerE8/s12
    this.states["/System/LayerE8/s12"] = new State(22, this);
    ...
    this.states["/System/LayerE10"] = new State(25, this);
    
    // state /System/LayerE10/s10
    this.states["/System/LayerE10/s10"] = new State(26, this);
    
    // state /System/LayerE10/s14
    this.states["/System/LayerE10/s14"] = new State(27, this);
    
    // state /System/LayerE10/s16
    this.states["/System/LayerE10/s16"] = new State(28, this);
    ...
    var _System_LayerE1_s1_1 = new Transition(this, this.states["/System/LayerE1/s1"], [this.states["/System/LayerE1/s13"]]);
    ...
    var _System_LayerE1_s13_1 = new Transition(this, this.states["/System/LayerE1/s13"], [this.states["/System/LayerE1/s13"]]);
    ...
    _System_Layercanvas_s2_3.setTrigger(new Event("event1", null));
    ...
    _System_LayerE10_s14_1.setTrigger(new Event("event3", null));
...
Interaction.prototype._System_LayerControler_h00_0_guard = function(parameters) {
    return this.inState(["/System/Layercanvas/s2"]) and this.inState(["/System/LayerE2/s0"]) and this.type == 'E1';
};
...
// add symbol 'Interaction' to package 'Synthetic50I'
Synthetic50I.Interaction = Interaction;
...
// add symbol 'ObjectManager' to package 'Synthetic50I'
Synthetic50I.ObjectManager = ObjectManager;
...
// add symbol 'Controller' to package 'Synthetic50I'
Synthetic50I.Controller = Controller;
})();