...
Date:   Sun Apr 28 00:35:50 2019

Model author: Vasco and Khady
Model name:   Synthetic10I
Model description:
RunGhostGameofLifeEditor*/


// package "Synthetic10I"
var Synthetic10I = {};
(function() {
...
Interaction.prototype.user_defined_constructor = function() {
    ...
    document.getElementById("E1").addEventListener("click", function() {Synthetic10I.Interaction.prototype.triggerEvent(event,"E1",'event');}, false);
    document.getElementById("E2").addEventListener("click", function() {Synthetic10I.Interaction.prototype.triggerEvent(event,"E2",'event');}, false);
    document.getElementById("E3").addEventListener("click", function() {Synthetic10I.Interaction.prototype.triggerEvent(event,"E3",'event');}, false);
    document.getElementById("E4").addEventListener("click", function() {Synthetic10I.Interaction.prototype.triggerEvent(event,"E4",'event');}, false);
    document.getElementById("E5").addEventListener("click", function() {Synthetic10I.Interaction.prototype.triggerEvent(event,"E5",'event');}, false);
    document.getElementById("E6").addEventListener("click", function() {Synthetic10I.Interaction.prototype.triggerEvent(event,"E6",'event');}, false);
    document.getElementById("E7").addEventListener("click", function() {Synthetic10I.Interaction.prototype.triggerEvent(event,"E7",'event');}, false);
    document.getElementById("E8").addEventListener("click", function() {Synthetic10I.Interaction.prototype.triggerEvent(event,"E8",'event');}, false);
    document.getElementById("E9").addEventListener("click", function() {Synthetic10I.Interaction.prototype.triggerEvent(event,"E9",'event');}, false);
    document.getElementById("E10").addEventListener("click", function() {Synthetic10I.Interaction.prototype.triggerEvent(event,"E10",'event');}, false);
    document.getElementById("23").addEventListener("click",function() {Synthetic10I.Interaction.prototype.triggerEvent(event,event.target.id,'select');}, false);
};
...
Interaction.prototype.build_statechart_structure = function() {
    ...
    this.states["/System/LayerE7/s12"] = new State(18, this);
    
    // state /System/LayerE8
    this.states["/System/LayerE8"] = new State(19, this);
    
    // state /System/LayerE8/s8
    this.states["/System/LayerE8/s8"] = new State(20, this);
    
    // state /System/LayerE9
    this.states["/System/LayerE9"] = new State(21, this);
    
    // state /System/LayerE9/s9
    this.states["/System/LayerE9/s9"] = new State(22, this);
    
    // state /System/LayerE9/s13
    this.states["/System/LayerE9/s13"] = new State(23, this);
    ...
    this.states["/System/LayerControler"] = new State(26, this);
    
    // state /System/LayerControler/h00
    this.states["/System/LayerControler/h00"] = new State(27, this);
    
    // state /System/LayerController
    this.states["/System/LayerController"] = new State(28, this);
    
    // state /System/LayerController/controller
    this.states["/System/LayerController/controller"] = new State(29, this);
...
// add symbol 'Interaction' to package 'Synthetic10I'
Synthetic10I.Interaction = Interaction;
...
// add symbol 'ObjectManager' to package 'Synthetic10I'
Synthetic10I.ObjectManager = ObjectManager;
...
// add symbol 'Controller' to package 'Synthetic10I'
Synthetic10I.Controller = Controller;
})();