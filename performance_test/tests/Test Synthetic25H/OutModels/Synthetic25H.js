...
Date:   Sat Apr 27 23:43:15 2019

Model author: Vasco and Khady
Model name:   Synthetic25H
Model description:
RunGhostGameofLifeEditor*/


// package "Synthetic25H"
var Synthetic25H = {};
(function() {
...
Interaction.prototype.user_defined_constructor = function() {
    ...
    document.getElementById("E1").addEventListener("click", function() {Synthetic25H.Interaction.prototype.triggerEvent(event,"E1",'event');}, false);
    document.getElementById("E2").addEventListener("click", function() {Synthetic25H.Interaction.prototype.triggerEvent(event,"E2",'event');}, false);
    document.getElementById("E3").addEventListener("click", function() {Synthetic25H.Interaction.prototype.triggerEvent(event,"E3",'event');}, false);
    document.getElementById("E4").addEventListener("click", function() {Synthetic25H.Interaction.prototype.triggerEvent(event,"E4",'event');}, false);
    document.getElementById("E5").addEventListener("click", function() {Synthetic25H.Interaction.prototype.triggerEvent(event,"E5",'event');}, false);
    document.getElementById("E6").addEventListener("click", function() {Synthetic25H.Interaction.prototype.triggerEvent(event,"E6",'event');}, false);
    document.getElementById("E7").addEventListener("click", function() {Synthetic25H.Interaction.prototype.triggerEvent(event,"E7",'event');}, false);
    document.getElementById("E8").addEventListener("click", function() {Synthetic25H.Interaction.prototype.triggerEvent(event,"E8",'event');}, false);
    document.getElementById("E9").addEventListener("click", function() {Synthetic25H.Interaction.prototype.triggerEvent(event,"E9",'event');}, false);
    document.getElementById("E10").addEventListener("click", function() {Synthetic25H.Interaction.prototype.triggerEvent(event,"E10",'event');}, false);
    document.getElementById("23").addEventListener("click",function() {Synthetic25H.Interaction.prototype.triggerEvent(event,event.target.id,'select');}, false);
};
...
Interaction.prototype.build_statechart_structure = function() {
    ...
    this.states["/System/LayerE5/s12"] = new State(14, this);
    ...
    this.states["/System/LayerE10"] = new State(23, this);
    
    // state /System/LayerE10/s10
    this.states["/System/LayerE10/s10"] = new State(24, this);
    
    // state /System/LayerControler
    this.states["/System/LayerControler"] = new State(25, this);
    
    // state /System/LayerControler/h00
    this.states["/System/LayerControler/h00"] = new State(26, this);
    
    // state /System/LayerController
    this.states["/System/LayerController"] = new State(27, this);
    
    // state /System/LayerController/controller
    this.states["/System/LayerController/controller"] = new State(28, this);
...
// add symbol 'Interaction' to package 'Synthetic25H'
Synthetic25H.Interaction = Interaction;
...
// add symbol 'ObjectManager' to package 'Synthetic25H'
Synthetic25H.ObjectManager = ObjectManager;
...
// add symbol 'Controller' to package 'Synthetic25H'
Synthetic25H.Controller = Controller;
})();