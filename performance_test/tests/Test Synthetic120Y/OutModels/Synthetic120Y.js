...
Date:   Sun Apr 28 15:22:53 2019

Model author: Vasco and Khady
Model name:   Synthetic120Y
Model description:
RunGhostGameofLifeEditor*/


// package "Synthetic120Y"
var Synthetic120Y = {};
(function() {
...
Interaction.prototype.user_defined_constructor = function() {
    ...
    document.getElementById("E1").addEventListener("click", function() {Synthetic120Y.Interaction.prototype.triggerEvent(event,"E1",'event');}, false);
    document.getElementById("E2").addEventListener("click", function() {Synthetic120Y.Interaction.prototype.triggerEvent(event,"E2",'event');}, false);
    document.getElementById("E3").addEventListener("click", function() {Synthetic120Y.Interaction.prototype.triggerEvent(event,"E3",'event');}, false);
    document.getElementById("E4").addEventListener("click", function() {Synthetic120Y.Interaction.prototype.triggerEvent(event,"E4",'event');}, false);
    document.getElementById("E5").addEventListener("click", function() {Synthetic120Y.Interaction.prototype.triggerEvent(event,"E5",'event');}, false);
    document.getElementById("E6").addEventListener("click", function() {Synthetic120Y.Interaction.prototype.triggerEvent(event,"E6",'event');}, false);
    document.getElementById("E7").addEventListener("click", function() {Synthetic120Y.Interaction.prototype.triggerEvent(event,"E7",'event');}, false);
    document.getElementById("E8").addEventListener("click", function() {Synthetic120Y.Interaction.prototype.triggerEvent(event,"E8",'event');}, false);
    document.getElementById("E9").addEventListener("click", function() {Synthetic120Y.Interaction.prototype.triggerEvent(event,"E9",'event');}, false);
    document.getElementById("E10").addEventListener("click", function() {Synthetic120Y.Interaction.prototype.triggerEvent(event,"E10",'event');}, false);
    document.getElementById("23").addEventListener("click",function() {Synthetic120Y.Interaction.prototype.triggerEvent(event,event.target.id,'select');}, false);
};
...
Interaction.prototype.build_statechart_structure = function() {
    ...
    this.states["/System/LayerE5/s15"] = new State(18, this);
    
    // state /System/LayerE5/s18
    this.states["/System/LayerE5/s18"] = new State(19, this);
    ...
    this.states["/System/LayerE10"] = new State(29, this);
    
    // state /System/LayerE10/s10
    this.states["/System/LayerE10/s10"] = new State(30, this);
    
    // state /System/LayerE10/s16
    this.states["/System/LayerE10/s16"] = new State(31, this);
    
    // state /System/LayerControler
    this.states["/System/LayerControler"] = new State(32, this);
    
    // state /System/LayerControler/h00
    this.states["/System/LayerControler/h00"] = new State(33, this);
    
    // state /System/LayerController
    this.states["/System/LayerController"] = new State(34, this);
    
    // state /System/LayerController/controller
    this.states["/System/LayerController/controller"] = new State(35, this);
    ...
    _System_LayerE2_s17_0.setTrigger(new Event("event3", null));
    this.states["/System/LayerE2/s17"].addTransition(_System_LayerE2_s17_0);
    var _System_LayerE2_s17_1 = new Transition(this, this.states["/System/LayerE2/s17"], [this.states["/System/LayerE2/s0"]]);
    _System_LayerE2_s17_1.setAction(this._System_LayerE2_s17_1_exec);
    _System_LayerE2_s17_1.setTrigger(new Event("event4", null));
    ...
    _System_Layercanvas_s2_4.setTrigger(new Event("event1", null));
    ...
    var _System_LayerE4_s13_1 = new Transition(this, this.states["/System/LayerE4/s13"], [this.states["/System/LayerE4/s19"]]);
    _System_LayerE4_s13_1.setAction(this._System_LayerE4_s13_1_exec);
    _System_LayerE4_s13_1.setTrigger(new Event("event4", null));
    this.states["/System/LayerE4/s13"].addTransition(_System_LayerE4_s13_1);
    
    // transition /System/LayerE4/s19
    var _System_LayerE4_s19_0 = new Transition(this, this.states["/System/LayerE4/s19"], [this.states["/System/LayerE4/s13"]]);
    _System_LayerE4_s19_0.setAction(this._System_LayerE4_s19_0_exec);
    _System_LayerE4_s19_0.setTrigger(new Event("event0", null));
    this.states["/System/LayerE4/s19"].addTransition(_System_LayerE4_s19_0);
    var _System_LayerE4_s19_1 = new Transition(this, this.states["/System/LayerE4/s19"], [this.states["/System/LayerE4/s19"]]);
    _System_LayerE4_s19_1.setAction(this._System_LayerE4_s19_1_exec);
    _System_LayerE4_s19_1.setTrigger(new Event("event4", null));
    ...
    _System_LayerE5_s15_0.setTrigger(new Event("event2", null));
    this.states["/System/LayerE5/s15"].addTransition(_System_LayerE5_s15_0);
    var _System_LayerE5_s15_1 = new Transition(this, this.states["/System/LayerE5/s15"], [this.states["/System/LayerE5/s18"]]);
    _System_LayerE5_s15_1.setAction(this._System_LayerE5_s15_1_exec);
    _System_LayerE5_s15_1.setTrigger(new Event("event3", null));
    this.states["/System/LayerE5/s15"].addTransition(_System_LayerE5_s15_1);
    
    // transition /System/LayerE5/s18
    var _System_LayerE5_s18_0 = new Transition(this, this.states["/System/LayerE5/s18"], [this.states["/System/LayerE5/s15"]]);
    _System_LayerE5_s18_0.setAction(this._System_LayerE5_s18_0_exec);
    _System_LayerE5_s18_0.setTrigger(new Event("event2", null));
    ...
    _System_LayerE5_s18_1.setTrigger(new Event("event3", null));
    ...
    _System_LayerE10_s16_0.setTrigger(new Event("event2", null));
...
// add symbol 'Interaction' to package 'Synthetic120Y'
Synthetic120Y.Interaction = Interaction;
...
// add symbol 'ObjectManager' to package 'Synthetic120Y'
Synthetic120Y.ObjectManager = ObjectManager;
...
// add symbol 'Controller' to package 'Synthetic120Y'
Synthetic120Y.Controller = Controller;
})();